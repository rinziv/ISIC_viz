    ...
    <div id="app">
        <b-container>
            ...
            <b-row>
                <b-col>
                    <p>
                        Choose one of the case studies we selected from the select box below.
                    </p>
                        ...
                        <b-row no-gutters>
                            <b-col md="6">
                                <b-card-img
                                        ...
                                        alt="Image to explain" class="rounded-0"></b-card-img>
                            </b-col>
                            <b-col md="6">
                                <b-card-body>
                                    <b-card-text>
                                        <ul>
                                            ...
                                            <li>
                                                <b>Predicted class:</b> {{getClassFromId(current_explanation.class)}}
                                            </li>
                                            <li><b>Neighborhood:</b>
                                                <ul>
                        ...
                        <b-row no-gutters>
                            <b-col md="6">
                                <b-card-img :src="`explanations/Ex_${current_explanation_id}/counter_1.png`"
                                            alt="Counter example" class="rounded-0"></b-card-img>
                            </b-col>
                            <b-col md="6">
                                <b-card-body>
                                    <b-card-text>
                                        <ul>
                                            <li><b>Counter example class:</b>
            ...
            <b-row class="mt-4">
                <b-col>
                    ...
                    <p>The following images are generated syntethically and they are classified with class <b>{{getClassFromId(current_explanation.class)}}</b>
                        by the blackbox.</p>
                </b-col>
            </b-row>
            <b-row class="mb-5">
                <b-col v-for="i in [1,2,3,4]" :key="i">
                    <b-img thumbnail fluid :src="`explanations/Ex_${current_explanation_id}/proto_${i}.png`"
                           :alt="`Prototype Image ${i}`"></b-img>
                </b-col>
            </b-row>
            <b-row>
                <b-col>
                    <h4>Skin cancer descriptions</h4>
                    <p><strong>Melanoma</strong>: is a type of skin cancer taht developes from the pigment-producing cells known as
                    ...
                    <p><strong>Melanocytic nevus</strong>: is a type of melanocytic tumor that contains nevus cells. The most common
                    ...
                    <p><strong>Basal cell carcinoma</strong>: is the most common type of skin cancer. It often appears as a painless
                    ...
                    <p><strong>Actinic keratosis</strong>: is a pre-cancerous area of thick, scaly, or crusty skin. Size commonly ranges
                    ...
                    <p><strong>Dermatofibroma</strong>: is a benign skin growth. Dermatofibromas are hard solitary slow-growing papules
                        that may appear in a variety of colours, usually brownish to tan; they are often elevated or
                        pedunculated.</p>

                    <p><strong>Vascular lesion</strong>: is any medical condition that affects the integumentary system - the organ
